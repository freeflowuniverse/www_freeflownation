...
<div>
  ...
  {#if ambassadorsHtml}
    ...
    <p class="text-secondary text-center">
      ...
      world. Each of them believes in the values and mission of ThreeFold. They
      are proud Token Holders and all have a value-added network. Together these
      people serve on our community board driving the Foundation forward.
    </p>
